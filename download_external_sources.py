...
def wb_entry_key(store: str, start: dt.date, end: dt.date, reports_root: str, folder: str) -> str:
    # Единый исторический формат:
    # 2-6-2026 Портрет покупателя. Точки входа с 25-05-2026 по 31-05-2026.xlsx
    ...
    filename = (
        f"{generated_date} Портрет покупателя. "
        f"Точки входа с {period_start} по {period_end}.xlsx"
    )
    return (
